 ...
 * @author nikitabatra
 */
public class SampleController_single implements Initializable {
    
    World_single WorldObject = null;
    public SampleController_single getSampleController(){
        return this;
    }
    ...
    private void handleStartGameA1(ActionEvent event) throws InterruptedException, IOException{ // When startgame is selected
        ...
        if (this.WorldObject == null){
                this.WorldObject = new World_single(this);
