 ...
 * @author nikitabatra
 */
public class SampleController_multi_client implements Initializable {
    
    World_multi_client WorldObject = null;
    public SampleController_multi_client getSampleController(){
        return this;
    }
    ...
    private void handleStartGameA1(ActionEvent event) throws InterruptedException, IOException{ // When startgame is selected
        ...
        if (this.WorldObject == null){
                this.WorldObject = new World_multi_client(this);
...
//    }
    ...
    @FXML
    public void showWinner(Warrior_multi_client w, int Location){
