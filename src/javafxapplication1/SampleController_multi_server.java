...
import static World.World_multi.serverWorldController;
 ...
 * @author nikitabatra
 */
public class SampleController_multi_server implements Initializable {
    
    World_multi WorldObject = null;
    public SampleController_multi_server getSampleController(){
        return this;
    }
...
//////        Thread t = new GreetingServer(6000, "Hello!");
////        GreetingServer.main(new String[] {});
////        System.out.println("startServer() invoked!");
//////        t.start();
//        new Thread( () -> {
//            try {
...
//                    double clientWarrior = inputFromClient.readInt();
//
//                    //send time to client
...
//    }
    ...
    private void handleStartGameA1(ActionEvent event) throws InterruptedException, IOException{ // When startgame is selected
        ...
        if (this.WorldObject == null){
                this.WorldObject = new World_multi(this);
